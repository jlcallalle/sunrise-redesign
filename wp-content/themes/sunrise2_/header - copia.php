...
<meta name="description" content="Sunrise es un centro médico especializado en atender a los más pequeños. Brindamos atención de primer nivel en una larga lista de especialidades, sobre todo en el área de Neumología Pediátrica, lo que nos convierte en una clínica de vanguardia." />
...
<meta name="author" content="Jhonny Design" />
...
<!-- <link rel="stylesheet" href="<?php //blogisnfo( 'template_url' ); ?>/js/bootstrap/css/bootstrap.min.css" type="text/css" media="screen" /> -->
...
<link rel="stylesheet" href="<?php bloginfo( 'template_url' ); ?>/css/jhonny.css" type="text/css" media="screen" />
...
<a title="<?php echo get_option('home'); ?>"  href="<?php echo get_option('home'); ?>/">
				<img id="casita" src="<?php bloginfo('template_directory');?>/images/casita.png" /></a>
					...
					<div class="cloud"></div>
					<a href="https://www.facebook.com/SunriseCentroPediatrico" class="facebook" target="_blank"></a>
					<a href="https://twitter.com/Sunrise_CP" class="twitter" target="_blank"></a>
